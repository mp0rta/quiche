...
impl RecoveryOps for GRecovery {
    ...
    fn on_ack_received(
        ...
        skip_pn: Option<u64>, rtt_sample_allowed: bool, trace_id: &str,
        ...
        // `update_rtt` also feeds the pacer below, where it signals that
        // a fresh RTT sample was recorded, so the suppression applies to
        // it as well.
    ...
    #[cfg(any(test, feature = "multipath"))]
